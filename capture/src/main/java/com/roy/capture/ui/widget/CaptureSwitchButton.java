package com.roy.capture.ui.widget;
 ...
 * SwitchButton.
 */
public class CaptureSwitchButton extends View implements Checkable {
    ...
    public CaptureSwitchButton(Context context) {
        super(context);
        init(context, null);
    }

    public CaptureSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CaptureSwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public CaptureSwitchButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public interface OnCheckedChangeListener{
        void onCheckedChanged(CaptureSwitchButton view, boolean isChecked);
    }
