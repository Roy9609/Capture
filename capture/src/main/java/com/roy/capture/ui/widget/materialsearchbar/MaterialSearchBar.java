package com.roy.capture.ui.widget.materialsearchbar;
...
import com.roy.capture.ui.widget.materialsearchbar.adapter.DefaultSuggestionsAdapter;
import com.roy.capture.ui.widget.materialsearchbar.adapter.SuggestionsAdapter;
...
public class MaterialSearchBar extends FrameLayout implements View.OnClickListener,
    ...
    private void init(AttributeSet attrs) {
        inflate(getContext(), R.layout.capture_searchbar, this);
    ...
    public void OnItemClickListener(int position, View v) {
        if (v.getTag() instanceof String) {
            ...
            if (externalOnItemViewClickListener!=null) {
                externalOnItemViewClickListener.onItemClickListener(position,(String) v.getTag());
            }
        }
    ...
    private SuggestionsAdapter.ExternalOnItemViewClickListener externalOnItemViewClickListener;

    public void setExternalListener(SuggestionsAdapter.ExternalOnItemViewClickListener listener) {
        this.externalOnItemViewClickListener = listener;
    }
