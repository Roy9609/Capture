package com.roy.capture.ui.widget.jsonviewer.view;
...
import com.roy.capture.ui.widget.jsonviewer.adapter.BaseJsonViewerAdapter;
...
public class JsonItemView extends LinearLayout {
    ...
    private void initView() {
        ...
        LayoutInflater.from(mContext).inflate(R.layout.capture_jsonviewer_layout_item_view, this, true);
    ...
    public void showIcon(boolean isPlus) {
        ...
        mIvIcon.setImageResource(isPlus ? R.drawable.capture_jsonviewer_plus : R.drawable.capture_jsonviewer_minus);
        mIvIcon.setContentDescription(getResources().getString(isPlus ? R.string.capture_jsonViewer_icon_plus : R.string.capture_jsonViewer_icon_minus));
    }
